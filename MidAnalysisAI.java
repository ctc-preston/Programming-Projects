...
public class MidAnalysisAI extends AI {
	
	private double[] nodes = new double[10];
	
	public MidAnalysisAI() {
	...
	public MidAnalysisAI(double[][] weights, double[][] bias) {
		super(weights, bias);
		inputs = new double[5];
		outputs = new double[3];
	}
	...
	public AI factory(double[][] weights, double[][] bias) {
		return new MidAnalysisAI(weights, bias);
	}
